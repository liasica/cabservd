...
func (bu *BinUpdate) SetBrand(a adapter.Brand) *BinUpdate {
	bu.mutation.SetBrand(a)
	return bu
}
...
// SetBrand sets the "brand" field.
func (buo *BinUpdateOne) SetBrand(a adapter.Brand) *BinUpdateOne {
	buo.mutation.SetBrand(a)
	return buo
}
