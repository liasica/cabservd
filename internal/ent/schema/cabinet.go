...
func (Cabinet) Fields() []ent.Field {
    return []ent.Field{
        ...
        field.Enum("status").Default("initializing").Values("initializing", "idle", "busy", "exchange", "abnormal").Comment("状态"), // initializing:初始化中 idle:空闲 busy:忙 abnormal:异常 exchange:换电中
